    ...
    <div className="min-h-screen bg-[#0C101A]">
      <header className="border-b border-[#2D3A5A] bg-[#11151D]">
        <div className="container mx-auto px-6 py-4 flex items-center justify-between">
          <h1 className="text-2xl font-bold text-white">Clipper Dashboard</h1>
      ...
      <main className="container mx-auto px-6 py-8">
        <div className="bg-[#11151D] rounded-xl border border-[#2D3A5A] p-8">
          <h2 className="text-4xl font-bold text-[#39D67C] mb-4">Clipper</h2>
          <p className="text-white/70 text-lg">
            Welcome to your Clipper dashboard. Here you can manage your clips and track your earnings.
          </p>
